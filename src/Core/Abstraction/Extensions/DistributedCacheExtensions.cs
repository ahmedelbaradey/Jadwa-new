...
namespace Abstraction.Common.Extensions
{
    public static class DistributedCacheExtensions
    {
        ...
        {
            return cache.SetAsync(key, value, new DistributedCacheEntryOptions().SetSlidingExpiration(TimeSpan.FromMinutes(30)).SetAbsoluteExpiration(TimeSpan.FromHours(1)));
        }
