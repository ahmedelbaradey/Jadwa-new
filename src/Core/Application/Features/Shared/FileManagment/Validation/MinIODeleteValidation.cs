...
{
    /// <summary>
    /// Validation rules for MinIO file delete operations
    /// </summary>
    public class MinIODeleteValidation : AbstractValidator<MinIODeleteCommand>
    {
        public MinIODeleteValidation(IStringLocalizer<SharedResources> localizer)
        {
            RuleFor(x => x.Id)
